...
if __name__ == '__main__':
    ...
    y_lims = [-200, 200]
    alpha = 0.7
    rejection_rms_threshold = [13.0+i*0.25 for i in range(9)]
    ...
    for ind in range(len(rejection_rms_threshold)):
        for index in df_data[df_data['mean_rms'] > rejection_rms_threshold[ind]][['i_freq', 'i_block']].to_numpy(dtype=int):
            # print(index)
